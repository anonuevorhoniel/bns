...
export function CreateServicePeriod() {
    ...
    const batchStoreSPMutation = useMutation({
        mutationFn: () => batchStoreSP({ selectedIds, setspCreateOpen }),
        onSuccess: () => {
            toast.success("Success", {
                description: "Service Period/s Created",
            });
    ...
    const content = (
        <div className="max-h-[70vh] overflow-auto p-6">
            ...
            <Card className="mt-3 relative p-0">

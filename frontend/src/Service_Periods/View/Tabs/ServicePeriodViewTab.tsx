...
export default function ServicePeriodViewTab({ dataView, viewPageInfo }: any) {
    ...
    return (
        <>
            <AlertReusable
                ...
                onClick={() => deleteSPMutation.mutate()}
            />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="flex items-center">
                    <Label>
                        Showing {viewPageInfo?.offset + 1} to{" "}
                        {viewPageInfo?.offset + viewPageInfo?.current_total} of{" "}
                        {viewPageInfo?.total} Service Periods
                    </Label>
                </div>
                <div className="flex justify-end">
                    <div>
                        <AutoPagination
                            page={page}
                            setPage={setPage}
                            totalPage={viewPageInfo?.total_page}
                        />
                    </div>
                </div>
            </div>

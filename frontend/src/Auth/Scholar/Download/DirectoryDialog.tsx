import { useDirectory } from "@/Actions/DownloadAction";
...
import { Building2, Check, ChevronsUpDown, Database, Download } from "lucide-react";
    ...
    return (
        <>
            <Dialog
                ...
                onOpenChange={setOpenDirectoryDialog}
            >
                <DialogContent className="sm:max-w-[425px]">
                    <Form {...directoryForm}>
                        ...
                        >
                            <DialogHeader>
                                <DialogTitle className="flex gap-2 justify-left items-center text-blue-500 font-bold"><Database /> Directory</DialogTitle>
                                <DialogDescription />
                            </DialogHeader>
